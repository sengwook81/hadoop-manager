...
public class SshClient_Old {

	protected static final Logger log = LoggerFactory.getLogger(SshClient_Old.class);
	
	SecureShellSession sshSession = null;

	public SshClient_Old(SecureShellSession session) {
	...
	public static void main(String[] args) {
		...
		SshClient_Old sc = new SshClient_Old(ssh);
